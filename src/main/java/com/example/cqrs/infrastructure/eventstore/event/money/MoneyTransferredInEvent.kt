...
class MoneyTransferredInEvent(
    ...
    companion object {
        fun of(
            ...
            eventDate: LocalDateTime,
            metadata: EventMetadata
        ): com.example.cqrs.infrastructure.eventstore.event.money.MoneyTransferredInEvent {
            return com.example.cqrs.infrastructure.eventstore.event.money.MoneyTransferredInEvent(
                accountId = accountId,
