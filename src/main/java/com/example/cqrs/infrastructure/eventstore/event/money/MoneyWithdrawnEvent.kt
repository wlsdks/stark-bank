...
class MoneyWithdrawnEvent(
    ...
    companion object {
        fun of(
            ...
            eventDate: LocalDateTime,
            metadata: EventMetadata
        ): com.example.cqrs.infrastructure.eventstore.event.money.MoneyWithdrawnEvent {
            return com.example.cqrs.infrastructure.eventstore.event.money.MoneyWithdrawnEvent(
                accountId = accountId,
                amount = amount,
                eventDate = eventDate,
                metadata = metadata
